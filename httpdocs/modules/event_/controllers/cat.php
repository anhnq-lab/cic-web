...
//            $tags_group = $cat -> tags_group;
			...
			$pagination = $model->getPagination($total1);
			...
			//$breadcrumbs[] = array(0=>'Tin tức', 1 => 'javascript: void(0)');
			...
			// var_dump($is_home);
			$tindanhmuc = $model->gettindanhmuc();
			$tindanhmuc1 = $model->gettindanhmuc1();
			// var_dump($tindanhmuc);
			// call views
			$danhmuc = $model->getdanhmuc();
			$danhmuc1 = $model->getdanhmuc1();
