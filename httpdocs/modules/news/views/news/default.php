...
$tmpl->addStylesheet('mucluc', 'modules/news/assets/css');
        ...
        <div class="section2 row">
            ...
            <div class="section2_right col-md-9">
                ...
                <div class="section2_right3">
                    <div class="content1" style="text-align: justify;"> <?php echo $tinchitiet->summary; ?></div>
                </div>
                <div class="section2_right4">
                    <div class="content2"><?php echo $tinchitiet->content; ?></div>
                </div>
                <!--                <div class="cmt_fb">-->
                <!--                    --><?php
...
<?php if ($tinchitiet->tawk_to) { ?>
    <?php echo $tinchitiet->tawk_to ?>
<?php } ?>