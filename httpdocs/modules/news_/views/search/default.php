		...
		<div class="wapper-content-page">
			...
			<div class='item'>
				<div class="news_title">
					<h2><a style="text-align: justify" href="<?php echo $link_news; ?>" title="<?php echo htmlspecialchars(@$news->title); ?>"><?php echo htmlspecialchars(@$news->title); ?></a></h2>
				</div>
				...
				<div class='frame_img_news'>
					...
					<div class="news_sum" style="text-align: justify">
