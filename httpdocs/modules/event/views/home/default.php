...
$tmpl->addStylesheet('event', 'modules/event/assets/css');
...
<section class="event">
    <div class="container">
        <div class="section1">
            <p class="content1"><?php echo FSText::_("Sự kiện") ?></p>
            <a href="<?php if ($lang == 'vi') {
                            echo URL_ROOT;
                        } else {
                            echo URL_ROOT . 'en';
                        } ?>"><?php echo FSText::_("Trang chủ") ?> ></a>
            <a href="#"><?php echo FSText::_("Sự kiện") ?></a>
        </div>
        <div class="box-1 ">
            <div class="box-left ">
                <div class="box-img">
            ...
            <div class="box-right ">
                ...
                <div class="content">
                    <a href="<?php echo $link_home ?>" class="title">
                    ...
                    <div class="box-dangky">
                        <a target="_blank" href="<?= $sukiensapdienra->link_dangky ?>" class="dang-ky text-uppercase"><?= FSText::_('Đăng ký ngay') ?></a>
                    </div>
                </div>
            </div>
        </div>
