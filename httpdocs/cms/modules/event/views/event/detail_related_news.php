    		...
    		<div class="col-xs-12 col-md-6">
    			<div id='news_related_r'>
					...
					<ul id='news_sortable_related'>	
						...
						?>
							<li id='news_record_related_<?php echo $item ->id?>'><strong><?php echo $item -> title; ?></strong>
								<a class='news_remove_relate_bt'  onclick="javascript: remove_news_related(<?php echo $item->id?>)" href="javascript: void(0)" title='Bỏ chọn'>
...
function set_news_related(id){
	...
	var html = '<li id="news_record_related_'+id+'"><strong>'+title+'</strong><input type="hidden" name="news_record_related[]" value="'+id+'" />';
	html += '<a class="news_remove_relate_bt"  onclick="javascript: remove_news_related('+id+')" href="javascript: void(0)" title="Xóa"><img border="0" alt="Remove" src="libraries/uploadify/delete.png"></a>';
	html += '<hr></li>';
...
#news_related_search_list, #news_sortable_related{
	height: 400px;
    overflow: scroll;
}
.news_related_item{
