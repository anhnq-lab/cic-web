...
<link rel="stylesheet" type="text/css" media="screen"
      href="<?php echo URL_ROOT . URL_ROOT_ADMIN ?>templates/default/css/bootstrap-datetimepicker.min.css"/>
<?php
global $toolbar;
...
//	CONFIG
$list_config = array();
//$list_config[] = array('title' => 'Tiêu đề tin', 'field' => 'title', 'ordering' => 1, 'type' => 'text_link', 'col_width' => '40%', 'link' => 'index.php?module=news&view=news&ccode=ccode&code=code&id=id&Itemid=4');

$list_config[] = array('title' => 'Tiêu đề sự kiện', 'field' => 'title', 'ordering' => 1, 'align' => 'left', 'type' => 'edit_text', 'col_width' => '40%', 'link' => 'index.php?module=news&view=news&ccode=ccode&code=code&id=id&Itemid=4');
...
$list_config[] = array('title' => 'Sự kiện nổi bật', 'field' => 'is_hot', 'ordering' => 1, 'type' => 'change_status', 'arr_params' => array('function' => 'is_hot'));
...
// $list_config[] = array('title' => 'Hiển thị trang chủ', 'field' => 'show_in_homepage', 'ordering' => 1, 'type' => 'change_status', 'arr_params' => array('function' => 'show_in_homepage'));
$list_config[] = array('title' => 'Show home', 'field' => 'show_in_home', 'ordering' => 1, 'type' => 'change_status', 'arr_params' => array('function' => 'show_in_home'));
