...
$this->dt_form_begin(1, 4, $title . ' ' . FSText::_('Sự kiện'), 'fa-edit', 1, 'col-md-8', 1);
TemplateHelper::dt_edit_text(FSText:: _('Tiêu đề sự kiện'), 'title', @$data->title);
TemplateHelper::dt_edit_text(FSText:: _('Chủ đề'), 'chu_de', @$data->chu_de);
TemplateHelper::dt_edit_text(FSText:: _('Alias'), 'alias', @$data->alias, '', 60, 1, 0, FSText::_("Can auto generate"));
TemplateHelper::dt_edit_text(FSText:: _('Địa điểm'), 'place', @$data->place);
TemplateHelper::datetimepicke(FSText:: _('Thời gian diễn ra sự kiện'), 'time_event', @$data->time_event , '', 20, FSText:: _('Bạn vui lòng chọn thời gian diễn ra sự kiện'), 'col-md-3', 'col-md-4');

TemplateHelper::dt_edit_text(FSText:: _('Thời gian cụ thể diễn ra sự kiện'), 'specific time', @$data->specific_time);
TemplateHelper::dt_edit_text(FSText:: _('Link đăng ký ngay'), 'link_dangky', @$data->link_dangky);
...
// BAI VIET LIEN QUAN
$this->dt_form_begin(1, 2, FSText::_('Sự kiện liên quan'), 'fa-book', 1, 'col-md-4 fl-right');

include 'detail_related_event.php';

$this->dt_form_end_col(); // END: col-1


$this->dt_form_begin(1, 2, FSText::_('Tin tức liên quan'), 'fa-book', 1, 'col-md-4 fl-right');

include 'detail_related_news.php';

$this->dt_form_end_col(); // END: col-1

$this->dt_form_begin(1, 2, FSText::_('Sản phẩm liên quan'), 'fa-book', 1, 'col-md-4 fl-right');
...
TemplateHelper::dt_checkbox(FSText::_('Sự kiện nổi bật'), 'is_hot', @$data->is_hot, 0, '', '', '', 'col-sm-4', 'col-sm-8');
TemplateHelper::dt_checkbox(FSText::_('Sự kiện lớn(Hiển thị 1 bài chính lớn ở hompage & sự kiện )'), 'show_in_home', @$data->show_in_home, 0, '', '', '', 'col-sm-4', 'col-sm-8');
