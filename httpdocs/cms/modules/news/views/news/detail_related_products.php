...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		if (keyword_tag) {
			$("#products_related_search_list").load("index2.php?module=news&view=news&task=ajax_get_products_related&raw=1", {
		...
		$('textarea#tags').on('change', function() {
			...
			$.ajax({
				type: 'POST',
				url: 'index2.php?module=news&view=news&task=ajax_get_products_related&raw=1',
				data: {
					keyword_tag: keyword_tag,
					str_related: str_related
				},
	...
	function search_products_related() {
		$('#products_related_search').click(function() {
			...
			$.get("index2.php?module=news&view=news&task=ajax_get_products_related&raw=1", {
				new_id: new_id,
