<?php 
	...
	class ImageModelsImage extends FSModels
	{
		...
		function __construct()
		{
			...
			$this -> arr_img_paths = array(
                                            array('resized',270,155,'cut_image'),
                                            array('small',120,74,'cut_image'),
                                            array('large',815,545,'cut_image')
                                        );
			// config for save
			$cyear = date('Y');
			$cmonth = date('m');
    ...
    //                        echo $image_small_width; die;
    			...
    			// default
    			$this->arr_img_paths = array (array ('large', 815, 545, 'resize_image' ), array ('resized', 270, 155, 'cut_image' ), array ('small', 47, 35, 'resize_image' ) );
    			$this->arr_img_paths_other = array (array ('large', 815, 545, 'resize_image' ), array ('resized', 270, 155, 'cut_image'  ), array ('small', 101, 67, 'resize_image' ) );
    		}
    	}
