...
class FS_PDO extends PDO
{
    ...
    function connect()
    {
        ...
        // PHP 8 fix: call parent::__construct() instead of creating separate PDO instance
        $dsn = 'mysql:host=' . $db_info['dbHost'] . ';dbname=' . $db_info['dbName'] . ';charset=utf8';
        $options = array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8");
        
        try {
            parent::__construct($dsn, $db_info['dbUser'], $db_info['dbPass'], $options);
        } catch (PDOException $e) {
            echo "Connection Error: " . $e->getMessage();
            die;
        }
        
        // Backward compatibility: $this->pdo points to $this (which IS a PDO now)
        $this->pdo = $this;
