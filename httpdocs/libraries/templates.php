...
class Templates
{
    ...
    public $title;
    public $style = array();
    public $style_rps = array();
    public $script_top = array();
    public $script_bottom = array();
    public $array_meta = array();
    public $arr_blocks = array();
    public $display_position = 0;
    public $title_maxlength = 70;
    public $metakey_maxlength = 170;
    public $metadesc_maxlength = 170;
    ...
    function __construct($file = null, $tmpl = null)
    {
        ...
        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/bootstrap.css");
        //        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/fontawesome.css");
        //        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/font-awesome.css");
        ...
        array_push($this->script_bottom, URL_ROOT . "libraries/jquery/jquery-1.12.4.min.js");
        ...
        //	array_push ( $this->script_bottom, URL_ROOT . "templates/" . TEMPLATE . "/js/script.min.js" );
...
?>
        ...
        <head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
            ...
            <meta property="og:title" content='<?php echo $this->get_variables('title'); ?>' />
            <!--            <meta property="og:url" content="https://--><?php //echo $_SERVER['HTTP_HOST'] . $_SERVER['REDIRECT_URL']; 
                                                                        ?><!--"/>-->
            <meta property="og:url" content="<?php echo $this->get_variables('og_url'); ?>" />
            ...
            <!--            <link rel="canonical" href="https://--><?php //echo $_SERVER['HTTP_HOST'] . $_SERVER['REDIRECT_URL']; 
                                                                    ?><!--"/>-->
            <link rel="canonical" href="<?php echo $this->get_variables('og_url'); ?>">
            <link rel="alternate" media="handheld"
                href="https://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REDIRECT_URL']; ?>" />
            <link rel="alternate" href="https://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REDIRECT_URL']; ?>"
                hreflang="x" />
            <link type='image/x-icon' href='<?php echo URL_ROOT . "images/favicon.ico"; ?>' rel='icon' />
            <link rel="alternate" type="application/rss+xml" title="<?php echo $config['site_name'] ?> Feed"
                href="<?php echo URL_ROOT; ?>rss.xml" />
            ...
            <!---->
            <!--            --><?php //global $config;
                                //            if ($config ['google_analytics'] && $config ['google_analytics'] != '') {
