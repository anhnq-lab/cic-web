...
//            print_r($html);
    ...
    function showAjaxPagination($maxpage = 5)
    {
        $previous = '<i class="fa left fa-angle-left " aria-hidden="true"></i>';
        //$next = "Tiếp";
        $next = '<i class="fa right fa-angle-right " aria-hidden="true"></i>';
        ...
        if ($this->limit < $this->total) {
            ...
            if (($current_page > 1) && ($num_of_page > 1)) {
                $html .= "<li class='page-item'>
                            <a class='page-link ' href='javascript:void(0)' title='first_page'  data-url='" . Pagination::create_link_with_page($url, 0) . "' title='" . FSText::_('First page') . "' >
                            " . $first_page . "
                            </a>
                        </li>";

                $html .= "<li class='page-item'>
                            <a class='page-link' href='javascript:void(0)' title='pre_page' data-url='" . Pagination::create_link_with_page($url, $current_page - 1) . "' title='" . FSText::_('Previous') . "' >
                            " . $previous . "
                            </a>
                            </li>";
//                if ($start_page != 1)
...
//            print_r($html);
            for ($i = $start_page; $i <= $end_page; $i++) {
                if ($i != $current_page) {
                    if ($i == 1)
                        $html .= "<li class='page-item'><a class='page-link' href='javascript:void(0)' title='Page " . $i . "' data-url='" . Pagination::create_link_with_page($url, 0) . "' >" . $i . "</a></li>";
                    else
                        $html .= "<li class='page-item'><a class='page-link' href='javascript:void(0)' title='Page " . $i . "' data-url='" . Pagination::create_link_with_page($url, $i) . "' >" . $i . "</a></li>";
                } else {
                    $html .= "<li class='page-item active '><a class='page-link' href='javascript:void(0)' title='Page " . $i . "' class='current'>" . $i . "</a></li>";
                }
            }
            //Write Next
            if (($current_page < $num_of_page) && ($num_of_page > 1)) {
...
//                    $html .= "<b>..</b>";
                $html .= "<li class='page-item'>
                            <a class='page-link' title='Next page' href='javascript:void(0)' data-url='" . Pagination::create_link_with_page($url, $current_page + 1) . "' >
                                " . $next . "</a>
                            </li>";
                $html .= "<li class='page-item'>
                            <a class='page-link' title='Last page' href='javascript:void(0)' data-url='" . Pagination::create_link_with_page($url, $num_of_page) . "' >
                                " . $last_page . "
                            </a>
                        </li>";
            }
